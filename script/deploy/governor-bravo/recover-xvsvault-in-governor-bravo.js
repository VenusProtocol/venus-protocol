...
(async () => {  
  ...
  const governorBravoDelegatorContractInstance = await saddle.getContractAt('GovernorBravoDelegate', governorBravoDelegatorAddress);
  ...
  console.log(`GovernorBravoDelegator - recovered to new XVSVaultProxy for Delegator with transactionStatus ${txn.status}`);  
