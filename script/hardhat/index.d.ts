...
export function deployGovernorBravoDelegator(config: { timelockAddress: string, xvsVaultAddress: string, guardianAddress: string, governorBravoDelegateAddress: string }): Contract { }
