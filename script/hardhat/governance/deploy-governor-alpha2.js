...
const main = async({ timelockAddress, xvsVaultAddress, guardianAddress, lastProposalId }) => {
    ...
    const governorAlpha2ContractInstance = await GovernorAlpha2Contract.deploy(timelockAddress, xvsVaultAddress, guardianAddress, lastProposalId);
    ...
    return governorAlpha2ContractInstance.address;
};
