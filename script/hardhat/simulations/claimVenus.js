...
async function claimVenus() {
    ...
    console.log(`${target}, after balance: ${afterVenusBalance}, claimed: ${(new BigNumber(afterVenusBalance) - new BigNumber(beforeVenusBalance)).toFixed(0)}`, );
}
