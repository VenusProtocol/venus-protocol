 ...
 * @author Venus
 */
contract VAIControllerTemp is VAIControllerStorageG2, VAIControllerErrorReporter, Exponential {
    ...
    /// @param vaiAdmin address of the new admin
    function addAdmin(address vaiAdmin) external onlyAdmin {
