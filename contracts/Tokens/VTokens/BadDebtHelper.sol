...
contract BadDebtHelper is Ownable2StepUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // THE market
    // ──────────────────────────────────────────────────────────
    IERC20Upgradeable public constant THE = IERC20Upgradeable(0xF4C8E32EaDEC4BFe97E0F595AdD0f4450a863a11);
    IVBep20 public constant V_THE = IVBep20(0x86e06EAfa6A1eA631Eab51DE500E3D474933739f);

    // ──────────────────────────────────────────────────────────
    // Token addresses (underlying)
    // ──────────────────────────────────────────────────────────
    IERC20Upgradeable public constant ETH_TOKEN = IERC20Upgradeable(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    IERC20Upgradeable public constant DAI = IERC20Upgradeable(0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3);
    IERC20Upgradeable public constant XRP = IERC20Upgradeable(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    IERC20Upgradeable public constant BCH = IERC20Upgradeable(0x8fF795a6F4D97E7887C79beA79aba5cc76444aDf);
    IERC20Upgradeable public constant LTC = IERC20Upgradeable(0x4338665CBB7B2485A8855A139b75D5e34AB0DB94);
    IERC20Upgradeable public constant LINK = IERC20Upgradeable(0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD);
    IERC20Upgradeable public constant ADA = IERC20Upgradeable(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    IERC20Upgradeable public constant USDC = IERC20Upgradeable(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
    IERC20Upgradeable public constant AAVE = IERC20Upgradeable(0xfb6115445Bff7b52FeB98650C87f44907E58f802);
    IERC20Upgradeable public constant DOGE = IERC20Upgradeable(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    IERC20Upgradeable public constant SXP = IERC20Upgradeable(0x47BEAd2563dCBf3bF2c9407fEa4dC236fAbA485A);
    IERC20Upgradeable public constant FIL = IERC20Upgradeable(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153);
    IERC20Upgradeable public constant TUSD = IERC20Upgradeable(0x40af3827F39D0EAcBF4A168f8D4ee67c121D11c9);

    // ──────────────────────────────────────────────────────────
    // vToken addresses (Core Pool)
    // ──────────────────────────────────────────────────────────
    IVBep20 public constant V_ETH = IVBep20(0xf508fCD89b8bd15579dc79A6827cB4686A3592c8);
    IVBep20 public constant V_USDT = IVBep20(0xfD5840Cd36d94D7229439859C0112a4185BC0255);
    IVBep20 public constant V_WBNB = IVBep20(0x6bCa74586218dB34cdB402295796b79663d816e9);
    IVBep20 public constant V_BTC = IVBep20(0x882C173bC7Ff3b7786CA16dfeD3DFFfb9Ee7847B);
    IVBep20 public constant V_CAKE = IVBep20(0x86aC3974e2BD0d60825230fa6F355fF11409df5c);
    IVBep20 public constant V_DAI = IVBep20(0x334b3eCB4DCa3593BCCC3c7EBD1A1C1d1780FBF1);
    IVBep20 public constant V_XRP = IVBep20(0xB248a295732e0225acd3337607cc01068e3b9c10);
    IVBep20 public constant V_BCH = IVBep20(0x5F0388EBc2B94FA8E123F404b79cCF5f40b29176);
    IVBep20 public constant V_LTC = IVBep20(0x57A5297F2cB2c0AaC9D554660acd6D385Ab50c6B);
    IVBep20 public constant V_LINK = IVBep20(0x650b940a1033B8A1b1873f78730FcFC73ec11f1f);
    IVBep20 public constant V_ADA = IVBep20(0x9A0AF7FDb2065Ce470D72664DE73cAE409dA28Ec);
    IVBep20 public constant V_USDC = IVBep20(0xecA88125a5ADbe82614ffC12D0DB554E2e2867C8);
    IVBep20 public constant V_AAVE = IVBep20(0x26DA28954763B92139ED49283625ceCAf52C6f94);
    IVBep20 public constant V_DOGE = IVBep20(0xec3422Ef92B2fb59e84c8B02Ba73F1fE84Ed8D71);
    IVBep20 public constant V_SXP = IVBep20(0x2fF3d0F6990a40261c66E1ff2017aCBc282EB6d0);
    IVBep20 public constant V_FIL = IVBep20(0xf91d58b5aE142DAcC749f58A49FCBac340Cb0343);
    IVBep20 public constant V_TUSD = IVBep20(0xBf762cd5991cA1DCdDaC9ae5C638F5B5Dc3Bee6E);
    IVBnb public constant V_BNB = IVBnb(0xA07c5b74C9B40447a954e1466938b865b6BBea36);

    // ──────────────────────────────────────────────────────────
    // Borrower addresses
    // ──────────────────────────────────────────────────────────
    address public constant ACCOUNT_1 = 0x1A35bD28EFD46CfC46c2136f878777D69ae16231;
    address public constant ACCOUNT_3 = 0x489A8756C18C0b8B24EC2a2b9FF3D4d447F79BEc;
    address public constant ACCOUNT_4 = 0x448ca4Bc5e3407Ce67bC9D7185cEf5B34C3ADEf8;
    address public constant ACCOUNT_5 = 0x85ca0Dff027102ea3FBF1c077524eab21D1F7927;
    address public constant ACCOUNT_6 = 0xdDBF9868D960FD2433BA762FAf46024881cd9916;
    address public constant ACCOUNT_8 = 0x1dc0F176519Ec89adc2fa16d0fb1163AFD617C9C;
    address public constant ACCOUNT_14 = 0xd4842aD6e4B96DE9c250857f0822897C5B283D0D;
    address public constant ACCOUNT_15 = 0x73b6a7A6E39A2E405087164d7F407A0Bd2c86dcc;
    address public constant ACCOUNT_16 = 0x2ee9D239DF727454D2BdF76AeA18F1c51aA196Cc;
    address public constant ACCOUNT_17 = 0xd7b67276FC0ef1079331494139F40Fa3632d6125;
    address public constant ACCOUNT_18 = 0x10e086957b9a5c0073f582AeEaDAed7C37f8df9d;
    address public constant ACCOUNT_19 = 0x9454f17a6BcC36CFBC8A07011B33DaFCebE4050b;
    address public constant ACCOUNT_20 = 0x0cEEDe04b0350e5251BA8919E131d60e3e063618;
    address public constant ACCOUNT_21 = 0xbb81DA9040B0Ea33D56Cf29a688856b40A7B400c;
    address public constant ACCOUNT_22 = 0xF942e8436918163590ec858279233A6f7EfCCd94;
    address public constant ACCOUNT_23 = 0xe73d283293Efe2d9225825Bc7a382F7008244c2B;
    address public constant ACCOUNT_24 = 0xc234723994B035CE916e8A02878163046Bc0940c;
    address public constant ACCOUNT_25 = 0xB71D994B57594D9A61be011cFcf901E4aa36788F;
    address public constant ACCOUNT_26 = 0x716Bab7286bE25CcE2Deb36e892056F4b4Ad07c9;
    address public constant ACCOUNT_27 = 0x770F97E8562EB40a181151587C2e473A604a18F6;

    // THE borrowers (from VIP-690)
    address public constant THE_BORROWER_1 = 0x737bc98F1D34E19539C074B8Ad1169d5d45dA619; // ACCOUNT_2
    address public constant THE_BORROWER_2 = 0x85ca0Dff027102ea3FBF1c077524eab21D1F7927; // ACCOUNT_5
    address public constant THE_BORROWER_3 = 0xA72e1756426100c6207421471449E2Ba9A917e86; // ACCOUNT_7
    address public constant THE_BORROWER_4 = 0x9958Ed7f2441c208821Ea14643224812A006D221; // ACCOUNT_9
    address public constant THE_BORROWER_5 = 0x6Efee96287B5e1a2Ef966E25baE15a54BDE9b83E; // ACCOUNT_10
    address public constant THE_BORROWER_6 = 0x2C58D31559d65242cF7915A4Fd89fCAB9c96F7dF; // ACCOUNT_11
    address public constant THE_BORROWER_7 = 0xDff9E1B12dFb7103231128940A19c2896f049de8; // ACCOUNT_12
    address public constant THE_BORROWER_8 = 0xA87f0d31846211Ce417128a770C681fC342D3a74; // ACCOUNT_13

    // ──────────────────────────────────────────────────────────
    // BNB repayment amounts (vBNB does NOT support type(uint256).max)
    // ──────────────────────────────────────────────────────────
    uint256 public constant BNB_REPAY_ACCOUNT_1 = 0.00926 ether;
    uint256 public constant BNB_REPAY_ACCOUNT_4 = 15.1157 ether;
    uint256 public constant BNB_REPAY_ACCOUNT_14 = 0.01397 ether;
    uint256 public constant BNB_REPAY_ACCOUNT_20 = 0.00672 ether;
    uint256 public constant BNB_REPAY_ACCOUNT_23 = 0.00558 ether;
    ...
    function _repayToken(IERC20Upgradeable underlying, IVBep20 vToken, address borrower) internal {
        if (!_approved) {
            ...
            approveOrRevert(underlying, address(vToken), balance);
            _approved = true;
        }
        ...
        emit BadDebtRepaid(address(vToken), borrower, debt);
    }
