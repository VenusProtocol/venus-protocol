...
contract VenusERC4626Factory is AccessControlledV8 {
    ...
    /// @custom:error VenusERC4626Factory__InvalidVToken is thrown when the provided vToken is not supported by the pool
    ...
    function createERC4626(address vToken) external returns (ERC4626Upgradeable vault) {
        ...
        venusERC4626.initialize2(accessControlManager, rewardRecipient, owner());
        ...
        emit CreateERC4626(VTokenInterface(vToken), vault);
    }
