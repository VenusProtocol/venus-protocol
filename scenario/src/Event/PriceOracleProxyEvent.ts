...
import { getEventV, getExpNumberV, getStringV } from "../CoreValue";
import { Event } from "../Event";
import { invoke } from "../Invokation";
import { EventV, NumberV, StringV } from "../Value";
  ...
  return [
    ...
    new View<{ priceOracleProxy: PriceOracleProxy; apiKey: StringV; contractName: StringV }>(
      ...
      (world, { priceOracleProxy, apiKey, contractName }) =>
        verifyPriceOracleProxy(world, priceOracleProxy, apiKey.val, contractName.val),
    ),
