...
​
      expect(blockNumber2.number - blockNumber1.number).equal(Number(supplySpeedBlock2.block) - Number(supplySpeedBlock1.block));
      expect(blockNumber2.number - blockNumber1.number).equal(Number(borrowSpeedBlock2.block) - Number(borrowSpeedBlock1.block));
    });
  });
});