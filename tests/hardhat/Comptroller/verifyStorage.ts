...
import { Comptroller__factory } from "./../../../typechain/factories/contracts/Comptroller/UpdatedComptroller.sol/Comptroller__factory";
...
describe("Verify Storage Collison", () => {
  ...
  describe("deploy updatedComprtroller and verify previous states", async () => {
    it("deploy updatedComptroller", async () => {
      const ComptrollerV1 = await ethers.getContractFactory("contracts/Comptroller/UpdatedComptroller.sol:Comptroller");
