...
describe("Evil Token test", async () => {
  ...
  beforeEach(async () => {
    ...
    await unitroller._setCollateralFactor(vToken1.address, convertToUnit(cf1, 18), convertToUnit(cf1, 18));
    ...
    await unitroller._setCollateralFactor(vToken2.address, convertToUnit(cf2, 18), convertToUnit(cf2, 18));
    ...
    await unitroller._setCollateralFactor(vToken3.address, convertToUnit(cf2, 18), convertToUnit(cf2, 18));
    await unitroller._setCollateralFactor(vToken3.address, convertToUnit(cf3, 18), convertToUnit(cf3, 18));
