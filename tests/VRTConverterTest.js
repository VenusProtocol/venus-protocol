...
describe('VRTConverterProxy', () => {
  ...
  describe("convert VRT to XVS", () => {
    ...
    it("alice can make multiple VRT conversions", async () => {
      ...
      const redeemableXVSAmountFromHarness_Conversion_1 = await call(vrtConversion, 'getXVSRedeemedAmount', [vrtTransferAmount_Conversion_1]);
      let xvsVestedAmount_Conversion_1 = new BigNum(vrtTransferAmount_Conversion_1).multipliedBy(new BigNum(conversionRatioMultiplier));
      ...
      const redeemableXVSAmountFromHarness_Conversion_2 = await call(vrtConversion, 'getXVSRedeemedAmount', [vrtTransferAmount_Conversion_2]);
      let xvsVestedAmount_Conversion_2 = new BigNum(vrtTransferAmount_Conversion_2).multipliedBy(new BigNum(conversionRatioMultiplier));
      ...
      expect(new BigNum(vrtTokensInBurnAddress)).toEqual(new BigNum(vrtTransferAmount_Conversion_1).plus(new BigNum(vrtTransferAmount_Conversion_2)));
      ...
      expect(new BigNum(totalConvertedAmount)).toEqual(new BigNum(vrtTransferAmount_Conversion_1).plus(new BigNum(vrtTransferAmount_Conversion_2)));
    });
  });
