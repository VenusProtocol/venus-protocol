module.exports = {
  ...
  networks: {
    ...
    testnet: {
      providers: [{ env: "PROVIDER" }, { file: "~/.bsc/testnet-url" }],
      web3: {
        gas: [{ env: "GAS" }, { default: "5900000" }],
        gas_price: [
          { env: "GAS_PRICE" },
    ...
    mainnet: {
      providers: [{ env: "PROVIDER" }, { file: "~/.bsc/mainnet-url" }],
      web3: {
        gas: [{ env: "GAS" }, { default: "10000000" }],
        gas_price: [
          { env: "GAS_PRICE" },
    ...
    ethmainnet: {
      ...
      web3: {
        gas: [{ env: "GAS" }, { default: "4600000" }],
        gas_price: [{ env: "GAS_PRICE" }, { default: "4000000000" }],
        options: {
          transactionConfirmationBlocks: 1,
          transactionBlockTimeout: 5,
        },
